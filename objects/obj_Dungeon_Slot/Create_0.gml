...
symbol_num = 3;
reels[0] = global.Dungeon_Reel_Layout[0]; //reels[] stores the symbol data for each reel
reels[1] = global.Dungeon_Reel_Layout[1];
reels[2] = global.Dungeon_Reel_Layout[2];
